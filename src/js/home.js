...
(function(){
  ...
  function showLi(index){
    var move = -index*liW
    $('.ul_1').stop().animate({'left':move},380)
  }
   */
  ...
  var day_show ="";
  var hour_show =document.querySelector('.time');
  var minute_show =document.querySelector('.fen');
  var second_show =document.querySelector('.miao');
  var date1 = new Date();
  var date2 = new Date(2020,7,28);
  ...
  console.log(111)
      $('.grid').each(function(index,item){
          $(this).click(function(){
            console.log($(this))
             var img=  $(this).find('.ppu').attr('src');
             var H2=  $(this).find('.hh').html();
             var price=  $(this).find('.gg').html();
             console.log(img);
             console.log(H2);
             console.log(price);
             var data ={
             ...
             sessionStorage.setItem('mouse',JSON.stringify(data));
